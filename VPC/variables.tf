...
variable "aws-subnet-public-1c-cidr-block" {
  description = "Subnet public 1c cidr block"
  default     = "10.3.0.0/24"
}

variable "aws-subnet-public-1c-availability-zone" {
  description = "AZ  public 1c cidr block"
...
variable "aws-subnet-private-1c-cidr-block" {
  description = "Subnet private 1c cidr block"
  default     = "10.6.0.0/24"
}

variable "aws-subnet-private-1c-availability-zone" {
  description = "AZ private 1c cidr block"
  default     = "eu-central-1c"
}
